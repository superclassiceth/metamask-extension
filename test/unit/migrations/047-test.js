...
describe('migration #47', function () {
  ...
  it('should stringify frequentRpcListDetail chainId values', async function () {
    const oldStorage = {
      meta: {},
      data: {
  ...
  it('should do nothing if frequentRpcListDetail state does not exist', async function () {
    const oldStorage = {
      meta: {},
      data: {
        PreferencesController: {
  ...
  it('should do nothing if frequentRpcListDetail state is empty', async function () {
    const oldStorage = {
      meta: {},
      data: {
        PreferencesController: {
